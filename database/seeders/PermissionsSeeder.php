...
class PermissionsSeeder extends Seeder
{
    ...
    {
        /** @var Role $adminRole */
        $adminRole = Role::firstOrCreate(["name" => "Admin"], ["color" => "#fa0000", "power" => 100]);
        $supportRole = Role::firstOrCreate(["name" => "Support-Team"], ["color" => "#00b0b3", "power" => 50]);
        $clientRole = Role::firstOrCreate(["name" => "Client"], ["color" => "#008009", "power" => 10]);
        $userRole = Role::firstOrCreate(["name" => "User"], ["color" => "#0052a3", "power" => 10]);
